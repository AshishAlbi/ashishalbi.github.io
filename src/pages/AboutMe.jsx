    ...
    <Box sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" } }}>
      ...
      <Box>
        <Typography
          ...
          developing dynamic and responsive web applications. My expertise lies
          in React, Node.js, HTML, CSS, JavaScript, and Three.js. I excel in
          both front-end and back-end development, crafting seamless user
          ...
          industry. Whether it's designing intuitive interfaces or optimizing
          application performance, I approach each project with dedication and
          creativity.
          <br />
          <br />
